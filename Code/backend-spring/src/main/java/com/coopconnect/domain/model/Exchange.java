...
/**
 * Exchange entity representing the exchange process between users.
 * Tracks the complete lifecycle of an exchange from request to completion.
 * 
...
@Table(name = "exchanges", indexes = {
    ...
    @Index(name = "idx_exchange_dates", columnList = "created_at,completed_at")
})
@Data
@Builder
@NoArgsConstructor
